...
import { getAdminUser, updateAdminUser } from '@/modules/admin/service';
...
/**
 * PATCH /api/v1/admin/users/[id] — update user (activate/deactivate, role management)
 */
export async function PATCH(
  ...
  try {
    ...
    const result = await updateAdminUser(user.id, id, parsed.data);
